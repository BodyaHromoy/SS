...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_half', models.IntegerField(null=True, verbose_name='FIRST_HALF')),
                ('second_half', models.IntegerField(null=True, verbose_name='SECOND_HALF')),
                ('date', models.DateTimeField(null=True, verbose_name='time')),
